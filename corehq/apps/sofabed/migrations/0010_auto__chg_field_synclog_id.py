...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'SyncLog.id'
        db.alter_column(u'sofabed_synclog', 'id', self.gf('django.db.models.fields.CharField')(max_length=64, primary_key=True))


    def backwards(self, orm):
        
        # Changing field 'SyncLog.id'
        db.alter_column(u'sofabed_synclog', u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True))
